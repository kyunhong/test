...
def get_all_students(
    ...
    records = db.query(ExamRecord).filter(
        ExamRecord.session_id == session_id,  # ✅ 추가
...
def get_detail_compare(
    ...
    subject_compare = {
        "korean":  {"curr_std": subj_avg(curr_records, "korean_std"),  "prev_std": subj_avg(prev_records, "korean_std"),  "curr_grade": subj_avg(curr_records, "korean_grade"),  "prev_grade": subj_avg(prev_records, "korean_grade")},
        "math":    {"curr_std": subj_avg(curr_records, "math_std"),    "prev_std": subj_avg(prev_records, "math_std"),    "curr_grade": subj_avg(curr_records, "math_grade"),    "prev_grade": subj_avg(prev_records, "math_grade")},
        "english": {"curr_std": None, "prev_std": None,                 "curr_grade": subj_avg(curr_records, "english_grade"), "prev_grade": subj_avg(prev_records, "english_grade")},
        "society": {"curr_std": subj_avg(curr_records, "society_std"), "prev_std": subj_avg(prev_records, "society_std"), "curr_grade": subj_avg(curr_records, "society_grade"), "prev_grade": subj_avg(prev_records, "society_grade")},
        "science": {"curr_std": subj_avg(curr_records, "science_std"), "prev_std": subj_avg(prev_records, "science_std"), "curr_grade": subj_avg(curr_records, "science_grade"), "prev_grade": subj_avg(prev_records, "science_grade")},
        "history": {"curr_std": None, "prev_std": None,                 "curr_grade": subj_avg(curr_records, "history_grade"), "prev_grade": subj_avg(prev_records, "history_grade")},
    }
